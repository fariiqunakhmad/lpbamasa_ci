...
<!--                                            <th data-halign="center"    data-sortable="true"    data-align="center" >No.</th>-->
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
<!--                                            <td><?php echo $no++; ?></td>-->
                                            <td><?php echo $row->IDPERAN; ?></td>
                                            <td><?php echo $row->NAMAPERAN; ?></td>
                                            <td><?php echo anchor("izin_peran/index/$row->IDPERAN", 'Daftar Izin'); ?></td>
<!--                                            <td><?php echo anchor($this->uri->slash_segment(1)."delete/$row->IDPERAN", 'Delete'); ?> | <?php echo anchor($this->uri->slash_segment(1)."load_form/$row->IDPERAN", 'Update'); ?></td>-->
                                        </tr>
                                        <?php endforeach; ?>
                                        <?php else : ?> 
