                        ...
                        <table class="table table-striped table-bordered table-hover" id="<?php echo $table;?>"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-halign="center" data-sortable="true" data-align="left" data-field="nip">Pegawai</th>
                                    <th data-halign="center" data-sortable="true" data-align="left">Peran</th>
                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td><?php echo $row->peran->NAMAPERAN; ?></td>
                                    <td><?php echo anchor($this->uri->slash_segment(1)."delete/$row->IDPERAN/$row->NIP", 'Delete'); ?> | <?php echo anchor($this->uri->slash_segment(1)."load_form/$row->IDPERAN/$row->NIP", 'Update'); ?></td>
                                </tr>
                                <?php endforeach; ?>
                                <?php else : ?> 
