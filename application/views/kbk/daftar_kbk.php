                            ...
                            <tbody>
                                ...
                                <tr class="gradeA">
                                    ...
                                    <td>
                                        <?php
                                        if($row->STATR==0){
                                            echo anchor($this->uri->slash_segment(1)."delete/$row->IDKBK", 'Delete');
                                            echo " | ";
                                            echo anchor($this->uri->slash_segment(1)."load_form/$row->IDKBK", 'Update');
                                        }else{
                                            echo anchor($this->uri->slash_segment(1)."restore/$row->IDKBK", 'Aktifkan Kembali');
                                        }
                                        ?>
                                    </td>
                                </tr>
