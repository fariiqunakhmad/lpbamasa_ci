                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <td>
                                                <?php
                                                if($row->STATR==0){
                                                    echo anchor($this->uri->slash_segment(1)."delete/$row->IDKBK/$row->IDA", 'Delete');
                                                    echo " | ";
                                                    echo anchor($this->uri->slash_segment(1)."load_form/$row->IDKBK/$row->IDA", 'Update');
                                                }else{
                                                    echo anchor($this->uri->slash_segment(1)."restore/$row->IDKBK/$row->IDA", 'Aktifkan Kembali');
                                                }
                                                ?>
                                            </td>
                                        </tr>
